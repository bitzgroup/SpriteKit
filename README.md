...
`SKPhysicsWorld`, `SKPhysicsBody`), and Phase 7b (physics contacts — `SKPhysicsContact`,
`SKPhysicsContactDelegate`) are complete. See [`docs/ROADMAP.md`](docs/ROADMAP.md) for the full
phased plan and progress checklist.
